...
#fnames = glob.glob('./test_images/test1.jpg')
#fnames = glob.glob('./test_images/straight_lines1.jpg')

fnames = []
for i in range(567,578):
# for i in range(1,10):
	fname = './video/' + str(i) + '.jpg'
...
for i, fname in enumerate(fnames):
	...
	# result = color_binary(undistorted)
	...
	print(fname)
	print("FINAL Left Radius of Curvature: ", left_curverad, 'm')
	print("FINAL Right Radius of Curvature: ",right_curverad, 'm')
